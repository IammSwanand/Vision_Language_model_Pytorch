...
import math
from SigLip_Modeling import SiglipVisionConfig, SiglipVisionModel
...
class PaliGemmaConfig():
    ...
    def __init__(
        ...
        self.vision_config = GemmaConfig(**text_config, pad_token_id=pad_token_id)
...
class GemmaRotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids, seq_len = None):
        ...
        device-type = device_type if isinstance(device_type, str) and device_type != "mps" else "cpu"
...
def apply_rotary_pos_emb(q, k, cos, sin, unsqueeze_dim=1):
    cos = cos.unsquezze(unsqueeze_dim)
